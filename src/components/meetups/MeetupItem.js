...
function MeetupItem(props) {
    const favoritesContext = useContext(FavoritesContext); //establishes connection between this component and a context (the object we created with createContext())
